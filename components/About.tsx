                ...
                <div className={`glass ${styles.aboutContent}`} style={{ padding: '40px' }}>
                    <div className={styles.text}>
                        <p style={{ marginBottom: '20px' }}>
                            I am a <span className={styles.highlight}>Full Stack Developer</span> with 1.5+ years of professional experience, specializing in <span className={styles.highlight}>AI-powered web applications</span> and modern development frameworks.
                        </p>
                        <p style={{ marginBottom: '20px' }}>
